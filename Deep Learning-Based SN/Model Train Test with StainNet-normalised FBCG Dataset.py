...
save_path = f'/content/drive/Shareddrives/Unlimited Drive/SN/{sn_label}'
...
model_Net.load_state_dict(torch.load("/content/StainNet/checkpoints/camelyon16_dataset/StainNet-Public-centerUni_layer3_ch32.pth"))
...
for type_folder in os.listdir(base_path):
  ...
  for grade_folder in os.listdir(type_path):
    ...
    for files in os.listdir(grade_path):
      ...
      file_name = str(files)
      cv.imwrite(file_name,image_net)
...
train_dir = f"/content/drive/Shareddrives/Unlimited Drive/SN/{sn_label}/Training Set"
test_dir = f"/content/drive/Shareddrives/Unlimited Drive/SN/{sn_label}/Test Set"
